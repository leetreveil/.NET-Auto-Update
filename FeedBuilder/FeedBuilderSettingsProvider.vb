...
Public Class FeedBuilderSettingsProvider
	...
	Public Overrides Sub Initialize(ByVal name As String, ByVal col As NameValueCollection)
		...
		If Not Directory.Exists(Me.GetAppSettingsPath) Then
			Try
				Directory.CreateDirectory(Me.GetAppSettingsPath)
	...
	Public Overridable Function GetAppSettingsPath() As String
		Return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), Me.ApplicationName)
	End Function
	...
	Public Overrides Sub SetPropertyValues(ByVal context As SettingsContext, ByVal propvals As SettingsPropertyValueCollection)
		...
		Try
			If Not Directory.Exists(Me.GetAppSettingsPath) Then Directory.CreateDirectory(Me.GetAppSettingsPath)
	...
	Private Function GetValue(ByVal setting As SettingsProperty) As String
		...
		Try
			...
			Else
				path = String.Format("{0}/{1}/{2}", SETTINGSROOT, My.Computer.Name, setting.Name)
			End If

			If setting.PropertyType.BaseType.Name = "CollectionBase" Then
	...
	Private Sub SetSerializedValue(ByVal node As Xml.XmlElement, ByVal propVal As SettingsPropertyValue)
		If propVal.Property.PropertyType.BaseType.Name = "CollectionBase" Then
